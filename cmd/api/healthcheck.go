...
// Declare a handler which writes a JSON response with information about
...
func (app *application) healthcheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	// forget to this, Go will default to sending a "Content-Type: text/plain;
	// charset=utf-8" header instead.
